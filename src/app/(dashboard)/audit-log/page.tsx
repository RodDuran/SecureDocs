  ...
  return (
    <div className="max-w-6xl mx-auto pb-12">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={exportCsv}
          className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-300 text-slate-700 font-medium rounded-md hover:bg-slate-50 transition-colors"
        >
          <Download size={16} />
          Export CSV
        </button>
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 mb-6 flex gap-4 items-end flex-wrap">
        ...
        <button onClick={handleApplyFilters} className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm font-medium h-[38px]">
          Apply Filters
        </button>
      </div>
